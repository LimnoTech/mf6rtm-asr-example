...
#
#
# ## Simple ASR Test Grid 1, 1.2ft near well
#
# Grid type: DISV  
...
# %% [markdown]
# ## Examine Courant Condition (Cr number)
...
# %%
Cr_sum.shape, Cr_max.shape

# %%
# Get descriptive Cr stats for layer 2 at each timestep
pd.DataFrame(Cr_sum[:,2,:]).T.describe()

# %% [markdown]
# ### Plot Cr

# %%
### inputs for functions to plot Cr
t_l = [0, 14, 33,-1] # list of timestep index (NOT actual time/days)
extent = (696400,697000,1025200,1025700)
layer = 2
Cr_type = 'Cr_sum'
f = f + 1
